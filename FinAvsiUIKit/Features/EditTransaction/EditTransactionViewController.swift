...
final class EditTransactionViewController: BaseViewController {
    ...
    override func configureAppearance() {
        ...
        saveBarButtonItem.accessibilityIdentifier = "editTransaction.saveButton"
    ...
    override func setupViews() {
        ...
        titleTextField.accessibilityIdentifier =
            "editTransaction.titleTextField"

        amountTextField.accessibilityIdentifier =
            "editTransaction.amountTextField"

        categoryTextField.accessibilityIdentifier =
            "editTransaction.categoryTextField"

        descriptionTextView.accessibilityIdentifier =
            "editTransaction.descriptionTextView"

        typeSegmentedControl.accessibilityIdentifier =
            "editTransaction.typeSegmentedControl"

        paymentMethodSegmentedControl.accessibilityIdentifier =
            "editTransaction.paymentMethodSegmentedControl"

        datePicker.accessibilityIdentifier =
            "editTransaction.datePicker"
    }
    ...
    private func configure(with transaction: Transaction) {
        ...
        typeSegmentedControl.selectedSegmentIndex =
            TransactionType.allCases.firstIndex(of: transaction.type) ?? 0

        paymentMethodSegmentedControl.selectedSegmentIndex =
            PaymentMethod.allCases.firstIndex(of: transaction.paymentMethod) ?? 0
    }
